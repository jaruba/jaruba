...
<html>
	...
	<body>
		<div id="content">
			...
			<br/>
			<div id="head-title">
				<h1>Alexandru Branza</h1> <span class="text-block left-space">Age 35</span> <span class="text-block left-space">Romania</span>
			</div>
			I build streaming platforms and work with video technologies
			<br/><br/>
			Creating products with good UX and clean designs, powerful tools that are easy to use
			<br/><br/>
